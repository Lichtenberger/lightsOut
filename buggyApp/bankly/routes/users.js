...
//fix bug #6 removes adminLogin as this is for user to patch
router.patch('/:username', authUser, requireLogin, async function(
  ...
  try {
    ...
    //fix bug #4 checks approved fields only or throws error
    ...
    //fix bug #3 checks for user else throws 404 error
    if(!user){
